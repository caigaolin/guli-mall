...
public class SpuBoundsController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("sms:spubounds:list")
    ...
    //@RequiresPermissions("sms:spubounds:info")
    ...
    //@RequiresPermissions("sms:spubounds:update")
    ...
    //@RequiresPermissions("sms:spubounds:delete")
